...
This note captures the key points and strategies for optimizing performance and training stability in machine learning models, incorporating the provided content and links as requested.